...
public class FeederMechanism {
	...
	public void toEnterDataIntoExcel(ArrayList<String> namelist) throws IOException {
		...
		BufferedReader bufferedreader = new BufferedReader(new FileReader("D:/UserData/sample.txt"));
		String FilePath = "D:\\UserData\\demo.xls";
		...
		FileOutputStream out = new FileOutputStream("D:\\UserData\\demo.xls");
		workbook.write(out);
		//workbook.close();
		out.close();
		fs.close();
